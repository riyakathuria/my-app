...
import CEPSettlement from "./CEPSettlement"; // ✅ Imported
    ...
    <div className="App">
      <nav className="navbar">
        ...
        <ul className="nav-links">
          ...
          <li><Link to="/cep-settlement">CEP Settlement</Link></li> {/* ✅ Added Link */}
      ...
      <Routes>
        ...
        <Route path="/cep-settlement" element={<CEPSettlement />} /> {/* ✅ Added Route */}
